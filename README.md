...
run_name="pretrain_mamba_sudoku"
...
arch.H_cycles=3 \
arch.L_cycles=6 \
arch.mamba_bimamba_v2_with_transformer=True \
arch.mlp_t=False \
ema=True \
+run_name=${run_name} \
...
arch.H_cycles=3 \
arch.L_cycles=6 \
arch.mamba_bimamba_with_transformer_and_nn=True \
arch.mlp_t=False \
ema=True \
+run_name=${run_name} \
...
arch.H_cycles=3 \
arch.L_cycles=6 \
arch.bilstm_with_nn=True \
arch.mlp_t=False \
ema=True \
+run_name=${run_name} \

run_name="bilstm_longer"
...
run_name="bimamba_v2_gating_final"
python pretrain.py \
arch=trm \
data_paths="[data/sudoku-extreme-1k-aug-1000]" \
data_paths_test="[]" \
...
run_name="state_dep_dual_mamba_dropout_final"
